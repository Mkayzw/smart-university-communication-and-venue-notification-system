...
export const EditScheduleScreen = ({ navigation, route }) => {
  ...
  const handleSubmit = () => {
    ...
    updateMutation.mutate({ ...form, courseId: courseValue, venueId: venueValue });
  };
      ...
      <ScrollView className="px-4 pt-4" keyboardShouldPersistTaps="handled">
        ...
        <View className="gap-y-4">
          <View style={{ zIndex: 3000 }}>
            <Text className="text-sm font-semibold text-slate-700 mb-1">Course <Text className="text-red-500">*</Text></Text>
          ...
          <View style={{ zIndex: 2000 }}>
            <View className="flex-row items-center mb-1">
              <Text className="text-sm font-semibold text-slate-700">Venue <Text className="text-red-500">*</Text></Text>
